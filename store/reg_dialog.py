...
class Ui_RegDialog(object):
    def setupUi(self, RegDialog):
        ...
        RegDialog.setMinimumSize(QtCore.QSize(400, 300))
        RegDialog.setMaximumSize(QtCore.QSize(400, 300))
        self.widget = QtWidgets.QWidget(RegDialog)
...
"")
        ...
        self.regButton.setGeometry(QtCore.QRect(130, 220, 161, 41))
        font = QtGui.QFont()
        font.setFamily("roboto")
        font.setPointSize(-1)
    ...
    def retranslateUi(self, RegDialog):
        ...
        RegDialog.setWindowTitle(_translate("RegDialog", "Dialog"))
        self.label.setText(_translate("RegDialog", "Логин"))
        self.label_2.setText(_translate("RegDialog", "Пароль"))
        self.regButton.setText(_translate("RegDialog", "Зарегистрироваться"))
